...
typedef struct {
	...
	uint16_t ltr329_intensity_ch0;
    uint16_t ltr329_intensity_ch1;
    ...
    int16_t mpu9250_x_accel;    // acceleration in .001g per unit
    int16_t mpu9250_y_accel;    // acceleration in .001g per unit
    int16_t mpu9250_z_accel;    // acceleration in .001g per unit

	uint8_t dummy2;

	int16_t stm32_temp;         // Temperature in 0.01°C per unit
	int16_t si446x_temp;        // Temperature in 0.01°C per unit

	int16_t tmp100_0_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_1_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_2_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_3_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_4_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_5_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_6_temp;      // Temperature in 0.01°C per unit
    int16_t tmp100_7_temp;      // Temperature in 0.01°C per unit
